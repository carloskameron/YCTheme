<?php
/*
Template Name: Plantilla Recuérdame Bonito
*/
?>
	...
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hidden-xs">
				...
				<h7 style="font-style: italic"> Oscar Wilde </h7>
			</div>
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
				...
				<h1 class="letraEuropaLight text-uppercase">
        			    ...
        			    <h6 class="letraEuropaLight"> &#8212; &nbsp; PERSONAL </h6>
...
$posts = get_posts( array( 'posts_per_page' => 50, 'category_name' => 'Recuérdame Bonito', ) );
