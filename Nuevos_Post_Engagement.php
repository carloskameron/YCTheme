<?php
/*
Template Name: Plantilla Engagement
*/
?>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
				...
				<h1 class="letraEuropaLight text-uppercase">
        			    ...
        			    <h6 class="letraEuropaLight"> &#8212; &nbsp; PAREJA </h6>
        			    
        	    <p class="text-justify letraCrhonicleDisplay " style="">
					 </br>
					 </br>
					 </br>
					“Sometimes the smallest step in the right direction ends up being the best step of your life".
			    </p>
			</div>
		</div>
...
$posts = get_posts( array( 'posts_per_page' => 50, 'category_name' => 'Engagement', ) );
