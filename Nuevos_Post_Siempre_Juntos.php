<?php
/*
Template Name: Plantilla Siempre Juntos
*/
?>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        	    ...
        	    <p class="text-justify letraCrhonicleDisplay " style="">
					...
					¨Aprendí que no se puede dar marcha atrás, que la esencia de la vida es ir hacía delante y estar con los que amas. La vida, en realidad, es una calle de sentido único¨.
			    </p>
			</div>
		</div>
...
$posts = get_posts( array( 'posts_per_page' => 50, 'category_name' => 'Siempre Juntos', ) );
